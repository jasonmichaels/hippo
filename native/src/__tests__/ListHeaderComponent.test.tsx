...
jest.mock("react", () => {
  ...
  return {
    ...React,
    useContext: () => ({ posts: { [mockPostA.id]: mockPostA, [mockPostB.id]: mockPostB } })
  }
})
...
describe('ListHeaderComponent', () => {
  ...
  test('authorId value change results in child Select\s textInput value to reflect as much', async () => {
    const { getByTestId, rerender } = render(<ListHeaderComponent {...props} />);
    ...
    rerender(<ListHeaderComponent authorId={mockPostA.author.id} navigation={props.navigation} />)
